...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_info.setGeometry(QtCore.QRect(90, 90, 561, 111))
        ...
        self.txt_sign.setGeometry(QtCore.QRect(90, 220, 561, 111))
        ...
        self.btn_verify.setGeometry(QtCore.QRect(480, 350, 75, 23))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_verify.setFont(font)
        self.btn_verify.setObjectName("btn_verify")
        self.btn_gen_keys = QtWidgets.QPushButton(self.centralwidget)
        self.btn_gen_keys.setGeometry(QtCore.QRect(390, 40, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
